package it.cineca.hr.desktop_application_working.userinterface;

import it.cineca.hr.desktop_application_working.constant.GameState;
import it.cineca.hr.desktop_application_working.gamezone.Coordinates;
...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
   ...
   private static final Color WINDOW_BACKGROND_COLOR = Color.rgb(0, 150, 136);
   private static final Color BOARD_BACKGROND_COLOR = Color.rgb(224, 242, 241);
   ...
   private void drawSudokuBoard(Group root) {
      ...
      boardBackground.setFill(BOARD_BACKGROND_COLOR);
   ...
   private void drawBackground(Group root) {
      ...
      scene.setFill(WINDOW_BACKGROND_COLOR);
